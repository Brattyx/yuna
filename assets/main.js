...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#container02', { style: 'blur-in', speed: 1625, intensity: 5, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('#container01', { style: 'blur-in', speed: 1625, intensity: 5, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('#container03', { style: 'blur-in', speed: 1625, intensity: 5, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('#container04', { style: 'blur-in', speed: 1625, intensity: 5, delay: 125, staggerOrder: '', replay: false });
		onvisible.add('#text01', { style: 'blur-in', speed: 1000, intensity: 5, delay: 500, staggerOrder: '', replay: false });
		onvisible.add('#text07', { style: 'fade-in', speed: 1000, intensity: 5, delay: 875, staggerOrder: '', replay: false });
		onvisible.add('#text06', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1250, staggerOrder: '', replay: false });
		onvisible.add('#list01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1625, stagger: 750, replay: false });
		onvisible.add('#text04', { style: 'fade-in', speed: 1000, intensity: 5, delay: 4250, staggerOrder: '', replay: false });
		onvisible.add('#buttons03', { style: 'blur-in', speed: 1000, intensity: 5, delay: 2500, stagger: 1250, replay: false });
		onvisible.add('#buttons02', { style: 'blur-in', speed: 1000, intensity: 5, delay: 2500, stagger: 1250, replay: false });
		onvisible.add('#image01', { style: 'blur-in', speed: 2250, intensity: 6, delay: 125, staggerOrder: '', replay: false });
